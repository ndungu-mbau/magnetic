...
export const enum_addresses_country = pgEnum('enum_addresses_country', ['KE'])
...
export const enum_carts_currency = pgEnum('enum_carts_currency', ['KES'])
...
export const enum_orders_currency = pgEnum('enum_orders_currency', ['KES'])
...
export const enum_transactions_currency = pgEnum('enum_transactions_currency', ['KES'])
...
export const addresses = pgTable(
  'addresses',
  {
    ...
    country: enum_addresses_country('country').notNull().default('KE'),
    phone: varchar('phone'),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
...
export const variants = pgTable(
  'variants',
  {
    ...
    priceInKESEnabled: boolean('price_in_k_e_s_enabled'),
    priceInKES: numeric('price_in_k_e_s', { mode: 'number' }),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
...
export const _variants_v = pgTable(
  '_variants_v',
  {
    ...
    version_priceInKESEnabled: boolean('version_price_in_k_e_s_enabled'),
    version_priceInKES: numeric('version_price_in_k_e_s', { mode: 'number' }),
    version_updatedAt: timestamp('version_updated_at', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
...
export const carts = pgTable(
  'carts',
  {
    ...
    currency: enum_carts_currency('currency').default('KES'),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
...
export const orders = pgTable(
  'orders',
  {
    ...
    currency: enum_orders_currency('currency').default('KES'),
...
export const transactions = pgTable(
  'transactions',
  {
    ...
    amount: numeric('amount', { mode: 'number' }),
    currency: enum_transactions_currency('currency').default('KES'),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
